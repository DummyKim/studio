...
const StrengthWeaknessSchema = z.object({
  description: z.string().describe('이 영역에서 발견된 점에 대한 2-3 문장의 구체적이고 상세한 설명 (한국어로 작성, "음슴체"로).'),
...
중요 지침:
- **구체적인 설명:** 강점과 약점의 'description'을 작성할 때, 한 문장으로 끝내지 말고 2~3문장으로 구체적이고 상세하게 설명해야 함. 왜 그것이 강점 또는 약점인지, 그리고 어떻게 개선할 수 있는지(약점의 경우) 명확히 제시해야 함.
